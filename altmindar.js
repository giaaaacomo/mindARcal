(() => {
    ...
    AFRAME.registerSystem("mindar-image-system", {
        ...
        tick: function () {},
        setup: function ({ imageTargetSrc: t, maxTrack: i, showStats: s, uiLoading: a, uiScanning: n, uiError: r, missTolerance: o, warmupTolerance: h, filterMinCF: l, filterBeta: d }) {
        ...
        start: function () {
            (this.container = this.el.sceneEl.parentNode),
                this.showStats &&
                    ((this.mainStats = new Stats()), this.mainStats.showPanel(0), (this.mainStats.domElement.style.cssText = "position:absolute;top:0px;left:0px;z-index:999"), this.container.appendChild(this.mainStats.domElement)),
                this.ui.showLoading(),
                this._startVideo();
        },
        ...
        _startVideo: function () {
            ...
            navigator.mediaDevices
                .getUserMedia({ audio: !1, video: { facingMode: "environment",  width: {ideal: 1280},
      height: {ideal: 720} } })
                .then((t) => {
        ...
        _startAR: async function () {
            ...
            const { dimensions: i } = await this.controller.addImageTargets(this.imageTargetSrc);
